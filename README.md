...
An integration for Resonite Mod ResoDiffusion [https://github.com/HamoCorp/ResoDiffusion]
...
- Inside ResoDiffusionIntegrations, create a folder called `stableDiffusion` and put integration.py inside
  (your folder should look like `Resonite/ResoDiffusionIntegrations/stableDiffusion/Integration.py`)
...
# todo
- add amd suport
- Compress to exe so no pip install required
- See if it works on Linux
